...
Configuration settings for Anthropic API Scanner.
"""
...
REGEX_LIST = [
    ...
    # Example: sk-ant-api03-... (95 chars after prefix)
    (re.compile(r"sk-ant-api03-[A-Za-z0-9_-]{95}"), True, True),
    # Alternative Anthropic key patterns
    # Example: sk-ant-... (48+ chars after prefix)
    (re.compile(r"sk-ant-[A-Za-z0-9_-]{48,}"), True, True),
    # Generic anthropic key pattern (legacy/alternative)
    # Example: ant_... (40+ chars after prefix)
